<x-app-layout>
    ...
    <div class="p-10">
        ...
        <form method="POST" action="{{ route('input-data-siswa') }}">
            ...
            <div class="relative z-0 mb-6 w-full group">
                Kelas Diniyah <select name="kamar" id="" class="bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0">
                    <option value="A. 1">A. 1</option>
                    <option value="A. 2">A. 2</option>
                    <option value="PUTRI">PUTRI</option>
                    <option value="PENGURUS">PENGURUS</option>
                    <option value="EMBEL">EMBEL</option>
                   </select>
            </div>
            <div class="relative z-0 mb-6 w-full group">
